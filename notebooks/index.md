...
@keyframes colorPop {
    0% { color: #000; }
    50% { color: #2b6cb0; text-shadow: 0 0 8px rgba(43,108,176,0.3); }
    100% { color: #000; }
}

.container {
    animation: slamIn 1s cubic-bezier(0.34, 1.56, 0.64, 1);
    max-width: 800px;
    padding: 1rem;
...
h1 { 
    animation: colorPop 2s 1.5s forwards;
}
...
@keyframes pulse {
    ...
    50% { transform: scale(1.4); opacity: 1; color: #ff4757; }
